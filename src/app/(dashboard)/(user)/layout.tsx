      ...
      `}
        >
          ...
          <div className="p-6 flex items-center justify-between">
            ...
            <button
              onClick={closeSidebar}
              className="cursor-pointer lg:hidden p-2 hover:bg-gray-800 rounded-lg"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
            ...
            <div className="px-4 py-4 lg:px-8 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="cursor-pointer p-2 hover:bg-gray-100 rounded-lg lg:hidden"
                >
                  <Menu className="w-6 h-6" />
                </button>
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">
                    Bienvenue {user ? user.name : "Anonyme"}
                  </h2>
                </div>
              </div>
