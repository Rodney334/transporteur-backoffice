// components/PromoColumnVisibilityToggle.tsx
...
interface PromoColumnVisibilityToggleProps {
...
const columnLabels: Record<ColumnKey, string> = {
  ...
  value: "Valeur",
  isActive: "Statut",
  usageLimit: "Limite utilisations",
  startsAt: "Date début",
  endsAt: "Date fin",
};

export default function PromoColumnVisibilityToggle({
  visibleColumns,
  onToggleColumn,
  onReset,
}: PromoColumnVisibilityToggleProps) {
