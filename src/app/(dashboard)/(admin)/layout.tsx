// admin dashboard layout - VERSION AVEC FILTRAGE PAR RÔLE ET SCROLL
"use client";
  ...
  return (
    ...
    >
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Sidebar - Structure modifiée pour le scroll */}
        <div
          className={`
      ...
      `}
        >
          ...
          <div className="p-4 border-t border-gray-800 shrink-0">
            {/* Informations du rôle - Intégré dans la zone scrollable */}
            <div className="px-2">
