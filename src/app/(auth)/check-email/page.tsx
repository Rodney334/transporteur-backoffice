      ...
      <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 text-sm">
            Cliquez sur le lien dans l'email pour activer votre compte. Vérifiez
            également vos spams au cas où.
          </p>
        </div>
        ...
        <div className="pt-6">
          <p className="text-gray-500 text-xs">
            Vous n'avez pas reçu l'email ? Attendez quelques minutes ou vérifiez
