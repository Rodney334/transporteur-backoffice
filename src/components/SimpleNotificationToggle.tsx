        ...
        return (
          <div className="flex items-center gap-2 text-sm text-green-600">
            ...
            <button
              ...
              disabled={isLoading}
              className="cursor-pointer text-xs text-gray-500 hover:text-gray-700 underline"
            >
              {isLoading ? "..." : "Gérer"}
            </button>
          </div>
      ...
      default: // "default"
        return (
          <button
            onClick={toggleNotifications}
            disabled={isLoading}
            className="cursor-pointer flex items-center gap-2 px-3 py-1 bg-[#FD481A] text-white text-sm rounded-lg hover:bg-[#E63F15] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {isLoading ? (
              <>
